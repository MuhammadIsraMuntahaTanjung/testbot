...
$TOKEN      = "1396323958:AAEkcP6z7cR961VgaCPxMAde-lvixNmFfs"; // ganti dengan token bot anda
$usernamebot= "@RaraCobaaBot"; // sesuaikan besar kecilnya, bermanfaat nanti jika bot dimasukkan grup.
...
function create_response($text, $message)
{
    ...
    if ($text == "/start") {
        ...
        $conn=mysqli_connect("ec2-34-225-162-157.compute-1.amazonaws.com","pxbhyxiglzmukw","c8eb9bd6ad89f3ef289c3408306490e21b69c5684efb72132eaf7a30961ebc26","d60pjh5d5cir6h");
        $nama_wisata = $text;
